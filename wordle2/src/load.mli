...
(** [parse_dict dict] returns a cleaned list of all the words contained in'
    [dict]*)


val choose_word_length: int -> string list -> string list
(** [choose_word_length dict length] returns a list of all the words of length
...
(** [dict_lst file] converts [file] into a string list that contains all words*)